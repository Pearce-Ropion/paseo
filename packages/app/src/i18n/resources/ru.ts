...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    power: {
      title: "Питание",
      keepAwake: "Не давать компьютеру засыпать, пока агенты работают",
      keepAwakeHint:
        "Предотвращает переход компьютера в спящий режим, пока агент активно работает. Автоматически отключается при уровне заряда батареи ниже 10%.",
    },
    hostSections: {
      projects: "Проекты",
